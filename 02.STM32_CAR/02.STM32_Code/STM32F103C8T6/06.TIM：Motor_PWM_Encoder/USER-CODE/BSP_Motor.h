...
#define Motor_Encoder_Clock1				RCC_APB2Periph_GPIOB
#define Motor_Encoder_Clock2				RCC_APB1Periph_TIM4
...
#define Motor_Encoder_Period				(0xFFFF)
#define Motor_Encoder_Prescaler			(1-1)
#define Motor_PWMA_ClockDivision		TIM_CKD_DIV1
#define Motor_Encoder_ClockDivision	TIM_CKD_DIV1
#define Motor_PWMA_CounterMode			TIM_CounterMode_Up
#define Motor_Encoder_CounterMode		TIM_CounterMode_Up
...
void Motor_Encoder_Init(void);	// 电机编码器初始化
